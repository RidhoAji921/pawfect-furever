        ...
        <div class="flex flex-col gap-10 p-10 rounded-[20px] bg-Orange/20 items-center w-full drop-shadow-[4px_8px_4px_rgba(0,0,0,0.25)]">
            ...
            <form class="flex flex-col gap-5 w-full">
                <div class="flex flex-col gap-3 w-full">
                    <label class="text-textTitle font-Quicksand text-Header4 font-bold">Email :</label>
                    <input type="email" placeholder="Masukan email anda ..." class="text-white opacity-text-60 font-Quicksand text-Large font-medium bg-Orange/70 px-4 py-2 rounded-[16px] w-full"></input>
                    <p class="text-[#FF181C] font-Quicksand text-base font-medium">! Gunakan email aktif untuk informasi lebih lanjut!</p>
                </div>
                <div class="flex flex-col gap-3 w-full">
                    <label class="text-textTitle font-Quicksand text-Header4 font-bold">No Hp :</label>
                    <input type="password" placeholder="Masukan no hp anda ... " class="text-white opacity-text-60 font-Quicksand text-Large font-medium bg-Orange/70 px-4 py-2 rounded-[16px] w-full" ></input>
                    <p class="text-[#FF181C] font-Quicksand text-base font-medium">! Gunakan no hp aktif untuk informasi lebih lanjut!</p>
                </div>
                <div class="flex flex-col gap-3 w-full">
                    <label class="text-textTitle font-Quicksand text-Header4 font-bold">Password :</label>
                    <input type="password" placeholder="Masukan password anda ... " class="text-white opacity-text-60 font-Quicksand text-Large font-medium bg-Orange/70 px-4 py-2 rounded-[16px] w-full" ></input>
                    <label class="text-textTitle font-Quicksand text-Header4 font-bold">Konfirmasi Password :</label>
                    <input type="password" placeholder="Masukan password anda ... " class="text-white opacity-text-60 font-Quicksand text-Large font-medium bg-Orange/70 px-4 py-2 rounded-[16px] w-full" ></input>
                </div>
            </form>
            <button class="flex justify-center items-center w-full gap-2 px-10 py-4 bg-Orange/10 rounded-2xl text-white font-Quicksand text-Header4 font-bold">Register
            ...
            <p class="text-white font-Quicksand text-Header4 font-semibold">Sudah punya akun?<span class="text-textTitle font-Quicksand text-Header4 font-semibold">Login Sekarang</span></p>
        </div>
    </div>
