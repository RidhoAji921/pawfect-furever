...
<body class="flex flex-col justify-center items-center gap-[60px] bg-backgroundColor w-full">
  <nav class="flex w-full justify-between items-center px-[60px]">
    ...
    <div class="flex items-center gap-2">
      ...
      <a href="/detail-reservasi" class="flex text-white font-Quicksand text-Header4 font-medium gap-2 px-3 py-2 bg-Orange/10 rounded-[12px] items-center">Cek Reservasi
