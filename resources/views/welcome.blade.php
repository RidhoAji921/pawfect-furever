  ...
  <div id="content" class="flex flex-col gap-10 justify-center items-center pb-10">
    <section id="home" class="flex flex-col items-center gap-4 px-[120px] w-full">
      ...
      <div class="flex w-full justify-between items-center">
        <p class="text-textTitle text-Header3 font-bold font-raleway w-full">Perawatan Terbaik untuk Hewan
          Peliharaan Anda.</p>
        <img src="{{ asset('images/Frame 13.png') }}" class="">
    ...
    <section id="service" class="flex flex-col gap-10 px-[120px] justify-center items-center w-full">
      <h1 class="text-textTitle font-Quicksand text-Header1 font-bold">Pelayanan Kami</h1>
      <div class="flex gap-10">
        <div class="flex flex-col gap-10 w-full">
          ...
          <div class="flex flex-col gap-5">
            <p class="text-textParagraph font-raleway text-Large font-medium">Pawfect Furever hadir dengan cinta dan dedikasi, menawarkan grooming berkualitas tinggi untuk memastikan hewan peliharaan merasa sempurna dan dicintai selamanya.</p>
        ...
        <div class="flex flex-col gap-10 w-full justify-center items-center">
          <div class="flex flex-col gap-5">
            <div class="flex gap-5 justify-center items-center w-fit">
              ...
              <p class="text-textTitle font-Quicksand text-Header4 font-semibold">Pet Grooming</p>
            </div>
          ...
          <div class="flex flex-col gap-5">
            <div class="flex gap-5 justify-center items-center w-fit">
              ...
              <p class="text-textTitle font-Quicksand text-Header4 font-semibold">Pet Hotel</p>
            </div>
          ...
          <div class="flex flex-col gap-5">
            <div class="flex gap-5 justify-center items-center w-fit">
              ...
              <p class="text-textTitle font-Quicksand text-Header4 font-semibold">Pet Walking & Sitting</p>
            </div>
    ...
    <section id="price" class="flex flex-col gap-10 px-[120px] justify-center items-center">
      <div class="flex flex-col gap-5 w-fit justify-center items-center">
        <h1 class="text-textTitle font-Quicksand text-Header1 font-bold">Daftar Harga Grooming</h1>
    ...
    <section id="why" class="flex gap-10 px-[120px]">
      ...
      <div class="flex flex-col gap-10">
        <h1 class="text-textTitle font-Quicksand text-Header1 font-bold">Kenapa Harus Groming di Pawfect Furever</h1>
        <div class="flex flex-col gap-[60px]">
          <div class="flex gap-10">
            <div class="flex flex-col gap-3">
              ...
              <p class="text-textTitle font-raleway text-Large font-bold">Lingkungan Ramah Hewan</p>
            ...
            <div class="flex flex-col gap-3">
              ...
              <p class="text-textTitle font-raleway text-Large font-bold">Sentuhan Profesional</p>
          ...
          <div class="flex gap-10">
            <div class="flex flex-col gap-3">
              ...
              <p class="text-textTitle font-raleway text-Large font-bold">Perawatan Berkualitas</p>
            ...
            <div class="flex flex-col gap-3">
              ...
              <p class="text-textTitle font-raleway text-Large font-bold">Kesehatan dan Kebersihan</p>
