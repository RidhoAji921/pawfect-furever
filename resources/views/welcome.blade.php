...
<body class="flex flex-col justify-center items-center gap-[60px] bg-backgroundColor">
  ...
  <div id="content" class="flex flex-col gap-10 justify-center items-center pb-10">
    ...
    <section id="Service" class="flex flex-col gap-10 px-[120px] justify-center items-center w-full">
      ...
      <div class="flex gap-10">
        ...
        <div class="flex flex-col gap-10 w-full justify-center items-center">
          <div class="flex flex-col gap-5">
            <div class="flex gap-5 justify-center items-center w-fit">
            ...
            <p class="text-textParagraph font-raleway text-Large font-medium">Pet grooming adalah proses merawat dan membersihkan hewan peliharaan untuk menjaga kebersihan dan kesehatan mereka.</p>
          </div>
          ...
          <div class="flex flex-col gap-5">
            ...
            <p class="text-textParagraph font-raleway text-Large font-medium">Pet hotel adalah tempat penginapan sementara untuk hewan peliharaan dengan fasilitas perawatan dan kenyamanan layaknya di rumah.</p>
          </div>
          <div class="w-full h-[5px] bg-line rounded-full"> </div>
          <div class="flex flex-col gap-5">
            <div class="flex gap-5 justify-center items-center w-fit">
            ...
            <p class="text-textParagraph font-raleway text-Large font-medium">Pet walking dan sitting memberikan kenyamanan bagi hewan peliharaan Anda, memastikan mereka tetap aktif dan terawat saat Anda sibuk.</p>
          </div>
        </div>
      </div>
    </section>

    <section id="price" class="flex flex-col gap-10 px-[120px] justify-center items-center">
      ...
      <div class="flex gap-10 w-fit">
        <div class="flex flex-col gap-10 px-5 py-4 bg-Orange/20 rounded-[28px] h-fit">
          <p class="text-textTittle font-Quicksand text-Header4 font-bold">Mandi Biasa</p>
          <p class="text-textTittle font-Quicksand text-Header2 font-bold">Rp150.000</p>
          <div class="flex flex-col gap-4">
            <div class="flex gap-2">
              ...
              <p class="text-textTittle font-raleway text-Large font-bold">Mandi</p>
            </div>
            <div class="flex gap-2">
              <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="#570F29"  class="icon icon-tabler icons-tabler-filled icon-tabler-circle-check"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M17 3.34a10 10 0 1 1 -14.995 8.984l-.005 -.324l.005 -.324a10 10 0 0 1 14.995 -8.336zm-1.293 5.953a1 1 0 0 0 -1.32 -.083l-.094 .083l-3.293 3.292l-1.293 -1.292l-.094 -.083a1 1 0 0 0 -1.403 1.403l.083 .094l2 2l.094 .083a1 1 0 0 0 1.226 0l.094 -.083l4 -4l.083 -.094a1 1 0 0 0 -.083 -1.32z" /></svg>
              <p class="text-textTittle font-raleway text-Large font-bold">Bersih Telinga</p>
            </div>
            <div class="flex gap-2">
              <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="#570F29"  class="icon icon-tabler icons-tabler-filled icon-tabler-circle-check"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M17 3.34a10 10 0 1 1 -14.995 8.984l-.005 -.324l.005 -.324a10 10 0 0 1 14.995 -8.336zm-1.293 5.953a1 1 0 0 0 -1.32 -.083l-.094 .083l-3.293 3.292l-1.293 -1.292l-.094 -.083a1 1 0 0 0 -1.403 1.403l.083 .094l2 2l.094 .083a1 1 0 0 0 1.226 0l.094 -.083l4 -4l.083 -.094a1 1 0 0 0 -.083 -1.32z" /></svg>
              <p class="text-textTittle font-raleway text-Large font-bold">Sikat Badan & Sisir Bulu</p>
            </div>
            <div class="flex gap-2">
              <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="#570F29"  class="icon icon-tabler icons-tabler-filled icon-tabler-circle-check"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M17 3.34a10 10 0 1 1 -14.995 8.984l-.005 -.324l.005 -.324a10 10 0 0 1 14.995 -8.336zm-1.293 5.953a1 1 0 0 0 -1.32 -.083l-.094 .083l-3.293 3.292l-1.293 -1.292l-.094 -.083a1 1 0 0 0 -1.403 1.403l.083 .094l2 2l.094 .083a1 1 0 0 0 1.226 0l.094 -.083l4 -4l.083 -.094a1 1 0 0 0 -.083 -1.32z" /></svg>
              <p class="text-textTittle font-raleway text-Large font-bold">Gunting Kuku</p>
            </div>
            <div class="flex gap-2">
              <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="#570F29"  class="icon icon-tabler icons-tabler-filled icon-tabler-circle-check"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M17 3.34a10 10 0 1 1 -14.995 8.984l-.005 -.324l.005 -.324a10 10 0 0 1 14.995 -8.336zm-1.293 5.953a1 1 0 0 0 -1.32 -.083l-.094 .083l-3.293 3.292l-1.293 -1.292l-.094 -.083a1 1 0 0 0 -1.403 1.403l.083 .094l2 2l.094 .083a1 1 0 0 0 1.226 0l.094 -.083l4 -4l.083 -.094a1 1 0 0 0 -.083 -1.32z" /></svg>
              <p class="text-textTittle font-raleway text-Large font-bold">Pewangi</p>
            </div>
            <div class="flex gap-2">
              ...
              <p class="text-textTittle font-raleway text-Large font-bold opacity-40">Sikat Gigi</p>
            </div>
            <div class="flex gap-2">
              <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="#570F29"  class="opacity-40 icon icon-tabler icons-tabler-filled icon-tabler-circle-check"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M17 3.34a10 10 0 1 1 -14.995 8.984l-.005 -.324l.005 -.324a10 10 0 0 1 14.995 -8.336zm-1.293 5.953a1 1 0 0 0 -1.32 -.083l-.094 .083l-3.293 3.292l-1.293 -1.292l-.094 -.083a1 1 0 0 0 -1.403 1.403l.083 .094l2 2l.094 .083a1 1 0 0 0 1.226 0l.094 -.083l4 -4l.083 -.094a1 1 0 0 0 -.083 -1.32z" /></svg>
              <p class="text-textTittle font-raleway text-Large font-bold opacity-40">Cukur Rapi</p>
            </div>
            <div class="flex gap-2">
              <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="#570F29"  class="opacity-40 icon icon-tabler icons-tabler-filled icon-tabler-circle-check"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M17 3.34a10 10 0 1 1 -14.995 8.984l-.005 -.324l.005 -.324a10 10 0 0 1 14.995 -8.336zm-1.293 5.953a1 1 0 0 0 -1.32 -.083l-.094 .083l-3.293 3.292l-1.293 -1.292l-.094 -.083a1 1 0 0 0 -1.403 1.403l.083 .094l2 2l.094 .083a1 1 0 0 0 1.226 0l.094 -.083l4 -4l.083 -.094a1 1 0 0 0 -.083 -1.32z" /></svg>
              <p class="text-textTittle font-raleway text-Large font-bold opacity-40">Perawatan Bulu</p>
            </div>
            <div class="flex gap-2">
              <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="#570F29"  class="opacity-40 icon icon-tabler icons-tabler-filled icon-tabler-circle-check"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M17 3.34a10 10 0 1 1 -14.995 8.984l-.005 -.324l.005 -.324a10 10 0 0 1 14.995 -8.336zm-1.293 5.953a1 1 0 0 0 -1.32 -.083l-.094 .083l-3.293 3.292l-1.293 -1.292l-.094 -.083a1 1 0 0 0 -1.403 1.403l.083 .094l2 2l.094 .083a1 1 0 0 0 1.226 0l.094 -.083l4 -4l.083 -.094a1 1 0 0 0 -.083 -1.32z" /></svg>
              <p class="text-textTittle font-raleway text-Large font-bold opacity-40">Pengobatan Kulit</p>
            </div>
          </div>
        ...
        <div class="flex flex-col justify-center items-center">
          ...
          <div class="flex flex-col gap-10 px-5 py-4 bg-Orange/20 rounded-[28px]">
            <p class="text-textTittle font-Quicksand text-Header4 font-bold">Mandi Lengkap</p>
            <p class="text-textTittle font-Quicksand text-Header2 font-bold">Rp300.000</p>
            <div class="flex flex-col gap-4">
              <div class="flex gap-2">
                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="#570F29"  class="icon icon-tabler icons-tabler-filled icon-tabler-circle-check"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M17 3.34a10 10 0 1 1 -14.995 8.984l-.005 -.324l.005 -.324a10 10 0 0 1 14.995 -8.336zm-1.293 5.953a1 1 0 0 0 -1.32 -.083l-.094 .083l-3.293 3.292l-1.293 -1.292l-.094 -.083a1 1 0 0 0 -1.403 1.403l.083 .094l2 2l.094 .083a1 1 0 0 0 1.226 0l.094 -.083l4 -4l.083 -.094a1 1 0 0 0 -.083 -1.32z" /></svg>
                <p class="text-textTittle font-raleway text-Large font-bold">Mandi</p>
              ...
              <div class="flex gap-2">
                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="#570F29"  class="icon icon-tabler icons-tabler-filled icon-tabler-circle-check"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M17 3.34a10 10 0 1 1 -14.995 8.984l-.005 -.324l.005 -.324a10 10 0 0 1 14.995 -8.336zm-1.293 5.953a1 1 0 0 0 -1.32 -.083l-.094 .083l-3.293 3.292l-1.293 -1.292l-.094 -.083a1 1 0 0 0 -1.403 1.403l.083 .094l2 2l.094 .083a1 1 0 0 0 1.226 0l.094 -.083l4 -4l.083 -.094a1 1 0 0 0 -.083 -1.32z" /></svg>
                <p class="text-textTittle font-raleway text-Large font-bold">Sikat Gigi</p>
              </div>
              <div class="flex gap-2">
                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="#570F29"  class="icon icon-tabler icons-tabler-filled icon-tabler-circle-check"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M17 3.34a10 10 0 1 1 -14.995 8.984l-.005 -.324l.005 -.324a10 10 0 0 1 14.995 -8.336zm-1.293 5.953a1 1 0 0 0 -1.32 -.083l-.094 .083l-3.293 3.292l-1.293 -1.292l-.094 -.083a1 1 0 0 0 -1.403 1.403l.083 .094l2 2l.094 .083a1 1 0 0 0 1.226 0l.094 -.083l4 -4l.083 -.094a1 1 0 0 0 -.083 -1.32z" /></svg>
                <p class="text-textTittle font-raleway text-Large font-bold">Cukur Rapi</p>
              </div>
              <div class="flex gap-2">
                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="#570F29"  class="icon icon-tabler icons-tabler-filled icon-tabler-circle-check"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M17 3.34a10 10 0 1 1 -14.995 8.984l-.005 -.324l.005 -.324a10 10 0 0 1 14.995 -8.336zm-1.293 5.953a1 1 0 0 0 -1.32 -.083l-.094 .083l-3.293 3.292l-1.293 -1.292l-.094 -.083a1 1 0 0 0 -1.403 1.403l.083 .094l2 2l.094 .083a1 1 0 0 0 1.226 0l.094 -.083l4 -4l.083 -.094a1 1 0 0 0 -.083 -1.32z" /></svg>
                <p class="text-textTittle font-raleway text-Large font-bold">Perawatan Bulu</p>
              </div>
              <div class="flex gap-2">
                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="#570F29"  class="icon icon-tabler icons-tabler-filled icon-tabler-circle-check"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M17 3.34a10 10 0 1 1 -14.995 8.984l-.005 -.324l.005 -.324a10 10 0 0 1 14.995 -8.336zm-1.293 5.953a1 1 0 0 0 -1.32 -.083l-.094 .083l-3.293 3.292l-1.293 -1.292l-.094 -.083a1 1 0 0 0 -1.403 1.403l.083 .094l2 2l.094 .083a1 1 0 0 0 1.226 0l.094 -.083l4 -4l.083 -.094a1 1 0 0 0 -.083 -1.32z" /></svg>
                <p class="text-textTittle font-raleway text-Large font-bold">Pengobatan Kulit</p>
              </div>
            </div>
            <button class="text-white font-raleway text-Large font-bold py-4 bg-Orange/10 rounded-[16px]">Beli Sekarang</button>
          </div>
    ...
    <section id="why" class="flex gap-10 px-[120px]">
      ...
      <div class="flex flex-col gap-10">
        <h1 class="text-textTittle font-Quicksand text-Header1 font-bold">Kenapa Harus Groming di Pawfect Furever</h1>
        <div class="flex flex-col gap-[60px]">
          <div class="flex gap-10">
            <div class="flex flex-col gap-3">
              ...
              <p class="text-textTittle font-raleway text-Large font-bold">Lingkungan Ramah Hewan</p>
            ...
            <div class="flex flex-col gap-3">
              ...
              <p class="text-textTittle font-raleway text-Large font-bold">Sentuhan Profesional</p>
              <p class="text-textParagraph font-raleway text-Base font-medium">Kami menggunakan teknik grooming terbaru dan alat berkualitas tinggi untuk memastikan setiap hewan peliharaan mendapatkan perawatan.</p>
            </div>
          </div>
          <div class="flex gap-10">
            <div class="flex flex-col gap-3">
              ...
              <p class="text-textTittle font-raleway text-Large font-bold">Perawatan Berkualitas</p>
            ...
            <div class="flex flex-col gap-3">
              ...
              <p class="text-textTittle font-raleway text-Large font-bold">Kesehatan dan Kebersihan</p>
