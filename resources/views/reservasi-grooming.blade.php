...
<body class="flex flex-col justify-center items-center overflow-x-hidden gap-16 bg-backgroundColor">
    ...
    <div id="modal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden z-20">
      <div class="flex flex-col p-10 gap-5 rounded-[40px] shadow-lg w-3/6 bg-Orange/20">
          ...
          <form id="reservationForm" class="flex flex-col gap-5" action="{{ route('reservation.store') }}" method="POST">
              @csrf
              ...
              <div class="flex flex-col gap-3">
                ...
                <div class="flex justify-between px-10 py-2 w-full bg-Orange/70 rounded-lg">
                    <p id="modalPackageName" class="text-white font-Quicksand text-Header3 font-bold">Nama Paket</p>
                    <p id="modalPackagePrice" class="text-white font-Quicksand text-Header3 font-bold">Rp0</p>
                </div>
              </div>
              ...
              <div class="flex justify-between w-full mt-5">
                  <button type="button" id="closeModal" class="flex gap-2 px-5 py-3 border-[2px] border-Orange/10 text-white font-Quicksand text-Header4 font-bold rounded-2xl">
                      Close
                  </button>
                  <button type="submit" id="confirmButton" class="flex gap-2 px-5 py-3 bg-Orange/10 text-white font-Quicksand text-Header4 font-bold rounded-2xl">
                      Konfirm
                  </button>
              </div>
          </form>
