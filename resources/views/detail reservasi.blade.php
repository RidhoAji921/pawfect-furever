...
<body class="flex flex-col justify-center items-center overflow-x-hidden gap-16 bg-backgroundColor">
  ...
  <section class="flex flex-col gap-10 px-[120px] justify-center items-center">
    <h1 class="text-textTittle font-Quicksand text-Header1 font-bold">Detail Reservasi</h1>
        ...
        <div class="flex flex-warp gap-10">
            <div class="flex gap-4 px-4 py-4 bg-Orange/20 w-[530px] rounded-[36px]">
                <div class="flex flex-col gap-2 w-fit h-full justify-center items-center">
                    <p class="text-textTittle font-Quicksand text-Large font-semibold">Sep</p>
                    <div class="flex w-[30px] h-[30px] rounded-full bg-Orange/70 items-center justify-center text-textTittle font-Quicksand text-Large font-medium">18</div>
                    <div class="bg-textTittle h-full w-[4px] rounded-full"> </div>
                </div>
