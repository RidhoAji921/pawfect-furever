    ...
    <div class="flex flex-col w-fit justify-center items-center h-full">
        ...
        <div class="flex flex-col gap-10 p-10 rounded-[20px] bg-Orange/20 items-center w-full drop-shadow-[4px_8px_4px_rgba(0,0,0,0.25)]">
            ...
            <form class="flex flex-col gap-5 w-full">
                ...
                <button class="flex justify-center items-center w-full gap-2 px-10 lg:py-4 py-3 bg-Orange/10 rounded-2xl text-white font-Quicksand lg:text-Header4 text-Large font-bold">Submit
            ...
            <p class="text-white font-Quicksand lg:text-Header4 text-[12px] font-semibold">Belum punya akun?<span class="text-textTitle font-Quicksand lg:text-Header4 text-[12px] font-semibold">Daftar Sekarang</span></p>
        </div>
    </div>
