...
<body class="bg-gradient-to-t from-[#F8EDE3] from-0% via-[#F6B171] via-50% to-[#F7D1AE] to-80% flex flex-col justify-center items-center py-5 px-32 gap-10 bg-no-repeat">
    <div class="flex flex-col w-fit justify-center items-center">
        ...
        <div class="flex flex-col gap-10 p-10 rounded-[20px] bg-Orange/20 items-center w-full drop-shadow-[4px_8px_4px_rgba(0,0,0,0.25)]">
            <h1 class="text-textTitle font-Quicksand text-Header2 font-bold">Lupa Password</h1>
            <form class="flex flex-col gap-5 w-full">
                ...
                <div class="flex flex-col gap-3 w-full">
                    <label class="text-textTitle font-Quicksand text-Header4 font-bold">Password Baru :</label>
                    ...
                    <label class="text-textTitle font-Quicksand text-Header4 font-bold">Konfirmasi Password Baru :</label>
                    <input type="password" placeholder="Masukan password anda ... " class="text-white opacity-text-60 font-Quicksand text-Large font-medium bg-Orange/70 px-4 py-2 rounded-[16px] w-full" ></input>
                </div>
            </form>
                <button class="flex justify-center items-center w-full gap-2 px-10 py-4 bg-Orange/10 rounded-2xl text-white font-Quicksand text-Header4 font-bold">Submit
            ...
            <p class="text-white font-Quicksand text-Header4 font-semibold">Belum punya akun?<span class="text-textTitle font-Quicksand text-Header4 font-semibold">Daftar Sekarang</span></p>
        </div>
    </div>
