    ...
    <body
        ...
        <section
            ...
            <div
                ...
                <div
                    class="flex justify-center items-center px-5 py-4 max-w-[680px] w-full bg-Orange/20 rounded-2xl border border-textTitle -mb-5 z-10">
                ...
                <div
                    class="flex lg:flex-row flex-col gap-5 lg:justify-between lg:items-center px-5 pt-10 pb-5 w-full bg-Orange/20 rounded-2xl border border-textTitle">
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex gap-3 items-center">
                            ...
                            <a class="openModal">
                                <svg
                                    ...
                                    stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1"/><path
                                    d="M20.385 6.585a2.1 2.1 0 0 0 -2.97 -2.97l-8.415 8.385v3h3l8.385 -8.415z"/><path d="M16 5l3 3"/></svg>
                            </a>
                        </div>
                    </div>
                    <div class="flex flex-col gap-2">
        ...
        <div id="modal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden z-20 lg:px-0 px-5">
            <div class="flex flex-col p-10 gap-5 rounded-[40px] shadow-lg lg:w-3/6 w-full bg-Orange/20">
                <form id="reservationForm" class="flex flex-col gap-5 h-fit justify-center items-center">
                    <h3 class="text-textTitle font-Quicksand lg:text-Header4 text-Large font-bold">Ganti Nama</h3>
                    <p class="text-textParagraph font-Quicksand lg:text-Large text-Base font-medium text-center">Masukkan nama baru Anda dan perbarui profil agar mencerminkan informasi yang benar.</p>
                    <input name="changeName" type="text" placeholder="Masukan Nama anda ... " class="text-white opacity-text-60 font-Quicksand lg:text-Large text-Base font-medium bg-Orange/70 px-4 py-2 rounded-[16px] w-full" ></input>
                    <button type="submit" id="confirmButton" class="flex justify-center items-center w-full lg:px-5 px-4 py-3 gap-2 bg-Orange/10 text-white font-Quicksand lg:text-Large text-Base font-bold rounded-2xl">
                      Submit
                ...
                <a id="closeModal" class="flex gap-1 items-center justify-center">
                    <svg  xmlns="http://www.w3.org/2000/svg"  width="20"  height="20"  viewBox="0 0 24 24"  fill="none"  stroke="#7C1A3E"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="lg:w-[25px] lg:h-[25px] icon icon-tabler icons-tabler-outline icon-tabler-chevron-left"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M15 6l-6 6l6 6" /></svg>
                    <p class="text-textParagraph font-Quicksand lg:text-Base text-Small font-medium">Kembali ke page</p>
                </a>
            </div>
        </div>
