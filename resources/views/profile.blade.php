    ...
    <body
            ...
            <h1
                ...
                <div
                    ...
                    <div class="flex flex-col w-full gap-5 lg:px-0 px-5 items-end justify-start lg:pb-0 pb-5">
                        <a class="openModal flex max-w-[130px] items-center justify-center w-full lg:px-5 px-2 py-2 bg-Orange/70 text-white font-Quicksand lg:text-Base text-Small font-bold rounded-2xl ">Edit Profile</a>
        ...
        <div id="modal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden z-20 lg:px-0 px-5">
            <div class="flex flex-col lg:p-10 p-5 gap-5 rounded-[40px] items-center shadow-lg lg:w-3/5 w-full bg-Orange/20">
                <h3 class="text-textTitle font-Quicksand lg:text-Header4 text-Large font-bold">Edit Profile</h3>
                ...
                <form id="reservationForm" class="flex flex-col gap-5 h-fit w-full justify-center items-center">
                    <div class="flex lg:flex-row flex-col gap-5 w-full items-center">
                        ...
                        <div class="flex flex-col gap-3 w-full">
                            ...
                            <input name="changeName" type="text" placeholder="Masukan Nama Baru anda ... " class="text-white opacity-text-60 font-Quicksand lg:text-Large text-Base font-medium bg-Orange/70 px-4 py-2 rounded-[16px] w-full" ></input>
                        </div>
                    </div>
                    <div class="flex lg:flex-row flex-col gap-5 w-full items-center">
                        <div class="flex flex-col gap-3 w-full">
                            <label class="text-textTitle font-Quicksand lg:text-Large text-Base font-bold">No Telepon</label>
                            <input name="changeName" type="Number" placeholder="Masukan Nama anda ... " class="text-white opacity-text-60 font-Quicksand lg:text-Large text-Base font-medium bg-Orange/70 px-4 py-2 rounded-[16px] w-full" ></input>
                        </div>
                        <div class="flex flex-col gap-3 w-full">
