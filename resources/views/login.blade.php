        ...
        <div class="flex flex-col lg:gap-10 gap-5 p-10 rounded-[20px] bg-Orange/20 items-center w-full drop-shadow-[4px_8px_4px_rgba(0,0,0,0.25)] h-fit">
            ...
            <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-5 w-full">
                ...
                <div class="flex flex-col gap-3 w-full">
                    ...
                    <input name="email" value="{{ old('email') }}" type="email" placeholder="Masukan email anda ..." class="text-white opacity-text-60 font-Quicksand lg:text-Large text-Base font-medium bg-Orange/70 px-4 py-2 rounded-[16px] w-full"></input>
                </div>
                <div class="flex flex-col gap-3 w-full">
                ...
                <div class="flex flex-col gap-5 items-end w-full">
                    <a href="/forgot-password" class="text-textTitle font-Quicksand lg:text-Header4 text-Large font-bold">Forgot Password</a>
                    <button type="submit" class="flex justify-center items-center w-full gap-2 px-10 lg:py-4 py-3 bg-Orange/10 rounded-2xl text-white font-Quicksand lg:text-Header4 text-Large font-bold">Login
