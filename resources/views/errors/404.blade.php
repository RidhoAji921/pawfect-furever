...
<body class="flex justify-center items-center px-5 md:px-32 h-screen bg-eror-page bg-cover bg-center bg-no-repeat object-cover">
    <div class="flex flex-col gap-10 items-center">
        <h1 class="text-textTitle font-raleway md:text-9xl text-Header1 font-bold">404</h1>
        <p class="text-textParagraph font-raleway md:text-Header4 text-Base font-medium text-center max-w-[660px]">Oops! Sepertinya kamu tersesat. Halaman yang kamu cari tidak ditemukan. Mari kembali ke halaman utama!</p>
        <a href="/" class="flex text-white font-Quicksand md:text-Header4 text-Base font-bold gap-2 px-5 md:px-10 py-3 md:py-4 bg-Orange/10 hover:bg-Orange/70  rounded-[12px] items-center drop-shadow-[2px_8px_4px_rgba(0,0,0,0.25)]">Kembali
