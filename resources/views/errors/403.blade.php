...
<body class="flex justify-center items-center px-5 md:px-32 h-screen bg-eror-page bg-cover bg-center bg-no-repeat object-cover">
    <div class="flex flex-col gap-10 items-center">
        ...
        <p class="text-textParagraph font-raleway md:text-Header4 text-Base font-medium text-center">Oops! Sepertinya kamu tersesat. Halaman yang kamu cari tidak ditemukan. Mari kembali ke halaman utama!</p>
